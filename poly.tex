...
them, they are not fields. The theory about quaternion algebras is very rich,
and they have deep connections to many objects in number theory, such as
...
\begin{definition}
The \emph{norm form} associated to the quaternion algebra $\left(\frac{a,b}{\Q}\right)$ is $t^2 - ax^2 - by^2 + abz^2$. 
\end{definition}
...
This is equivalent to the norm form having a nontrivial zero over $\Q_p$.
