...
\begin{theorem}[Deuring correspondence II] Let $E/\F_q$ be a supersingular
elliptic curve with endomorphisms ring $\End(E)\cong\O\subset B_{p,\infty}$.
The bijection in Theorem \ref{thm:deuring1} induces a one-to-one
correspondence
    \begin{equation*}
        \left\{
            \begin{tabular}{@{} c @{}}
                \emph{supersingular elliptic curves over $\F_q$}\\
...
\begin{lemma}
    ...
    In particular, it is an isomorphism onto the image $I(E[\varphi])$.
\end{lemma}
