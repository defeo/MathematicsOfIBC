...
\begin{theorem}[Sato-Tate]
  \label{th:sato-tate2}
  Two elliptic curves $E,E'$ are isogenous if and only if their
  endomorphisms algebras $\End(E)⊗ℚ$ and $\End(E')⊗ℚ$ are isomorphic.
\end{theorem}
...
\clearpage
\part{Isogeny based cryptography}
...
%  LocalWords:  supersingular irreducibility
