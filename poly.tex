...
\footnote{DDH is the \emph{decisional} variant of CDH: distinguish
  $(g,h,g^a,h^a)$ from a random tuple $(g,h,j,k)$ of group elements}.
...
\section{CSIDH and orientated  supersingular curves}
\label{sec:csidh}

Even with the adjustments of the previous section, the protocol is far
from practical: Stolbunov managed to run a 108 bit secure
implementation in around 5 minutes~\cite{Stolbunov2012}. %
To understand why, let's see recap how the CM group action is
computed. %
