...
There exists also a more precise, categorical statement of the Deuring
...
It is natural to ask whether the same could be done with the Deuring
correspondence.

We already know how to efficiently compute isogenies (in polynomial
time in their degree). %
The next question is how to represent and compute with quaternions,
ideals and orders. %
